...
export const ru: Record<TKey, string> = {
  ...
  "cws.attention.allExhausted": "Все цели исчерпали свою квоту — запросы будут отклонены",
  "cws.target.quotaExhausted": "Квота этого провайдера исчерпана (осталось 0 кредитов)",
  "cws.target.quotaExhaustedShort": "0 кредитов",
  "cws.allTargetsExhausted": "Все цели в этом комбо исчерпали свою квоту. Запросы будут отклонены до пополнения кредитов.",
