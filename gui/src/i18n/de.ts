...
export const de: Record<TKey, string> = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.attention.allExhausted": "Alle Ziele haben ihr Kontingent aufgebraucht — Anfragen schlagen fehl",
  "cws.target.quotaExhausted": "Dieser Anbieter hat sein Kontingent aufgebraucht (0 Guthaben übrig)",
  "cws.target.quotaExhaustedShort": "0 Guthaben",
  "cws.allTargetsExhausted": "Alle Ziele in diesem Combo haben ihr Kontingent aufgebraucht. Anfragen schlagen fehl, bis Guthaben aufgefüllt wird.",
