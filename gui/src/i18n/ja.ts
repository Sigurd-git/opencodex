...
export const ja: Record<TKey, string> = {
  ...
  "cws.attention.allExhausted": "全ターゲットのクォータが枯渇しています — リクエストは失敗します",
  "cws.target.quotaExhausted": "このプロバイダーのクォータが枯渇しています（残高 0）",
  "cws.target.quotaExhaustedShort": "残高 0",
  "cws.allTargetsExhausted": "このコンボの全ターゲットのクォータが枯渇しています。クレジットが補充されるまでリクエストは失敗します。",
