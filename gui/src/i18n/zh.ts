...
export const zh: Record<TKey, string> = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.attention.allExhausted": "所有目标的配额已耗尽 — 请求将以失败结束",
  "cws.target.quotaExhausted": "此供应商的配额已耗尽（剩余额度为 0）",
  "cws.target.quotaExhaustedShort": "0 额度",
  "cws.allTargetsExhausted": "此组合中所有目标的配额已耗尽。在额度补充之前，请求将以失败结束。",
