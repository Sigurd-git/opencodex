...
export const ko: Record<TKey, string> = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.attention.allExhausted": "모든 대상의 크레딧이 소진됨 — 요청이 실패 처리됩니다",
  "cws.target.quotaExhausted": "이 제공업체의 크레딧이 소진되었습니다 (잔여 0)",
  "cws.target.quotaExhaustedShort": "크레딧 0",
  "cws.allTargetsExhausted": "이 콤보의 모든 대상 크레딧이 소진되었습니다. 크레딧이 보충될 때까지 요청은 실패 처리됩니다.",
